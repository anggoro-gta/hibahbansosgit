...
use App\Models\tbinputhibahModel;
use App\Models\usersModel;

class Usulanhibahadmin extends BaseController
{
    protected $usersModel;
    protected $usulanhibah;

    public function __construct()
    {
        $this->usersModel = new usersModel();
        $this->usulanhibah = new tbinputhibahModel();
    }

    public function index()
    {
        $usulanhibah = $this->usulanhibah->getalldatainputhibah();        

        $data = [
            'tittle' => 'usulan hibah',
            'usulanhibah' => $usulanhibah
        ];

        return view('admin/indexusulanhibah', $data);
    }
