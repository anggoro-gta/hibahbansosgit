                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="<?= base_url('usulan/bansos/create') ?>" class="btn btn-sm btn-success"><i class="fa fa-plus mr-2"></i>Tambah</a>
                        </div>
                        <?php endif; ?>
                        <div class="card-body">
...
<script>
    $(function () {
        ...
        columns.push({
            ...
            render: r => `
                <a href="${BASE}usulan/bansos/edit/${r.id}" 
                    class="btn btn-sm btn-primary mb-1" title="Edit">
                    <i class="fa fa-edit"></i>
                </a>
                <a href="${BASE}usulan/bansos/delete/${r.id}" 
                    class="btn btn-sm btn-danger mb-1" title="Delete" 
                    onclick="return confirmDelete('${BASE}usulan/bansos/delete/${r.id}')">
        ...
        const table = $("#example1").DataTable({
            ...
            serverSide: false,
            ajax: {
                url: "<?= site_url('usulan/bansos/datatable'); ?>",
                type: "POST",
