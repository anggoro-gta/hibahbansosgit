...
<script>
    ...
    const ahrefviewusulanhibah = document.querySelector('.ahref-view-usulan-hibah');

    liviewadmin.classList.add("menu-open");
    ahrefviewadmin.classList.add('active');
    ahrefviewusulanhibah.classList.add('active');
</script>
<script>
    //Get the button
...
<script>
    $(function() {
        ...
        const table = $('#example1').DataTable({
            ...
            deferRender: true,
            ajax: {
                url: "<?= site_url('view/hibah/datatable'); ?>",
                type: "POST",
                data: d => {
                    d.kode_opd = kodeOpd;
