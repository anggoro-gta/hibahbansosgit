                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $counthibah = count($datahibah); ?>
                                        <?php for ($i = 0; $i < $counthibah; $i++) : ?>
                                            <tr>
                                                <td><?= $i + 1; ?></td>
                                                <td><?= $datahibah[$i]['nama_kabupaten']; ?></td>
                                                <td><?= $datahibah[$i]['nama_kecamatan']; ?></td>
                                                <td><?= $datahibah[$i]['nama_desa']; ?></td>
                                                <td><?= $datahibah[$i]['tgl_berdiri']; ?></td>
                                                <td><?= $datahibah[$i]['no_akta_hukum']; ?></td>
                                                <td>
                                                    <a href="/detailusulan/<?= $datahibah[$i]['id']; ?>"><button type="button" class="btn btn-block btn-info"><i class="fa fa-check"></i> edit</button></a>
                                                    <button onclick="showdelete('<?= $datahibah[$i]['id']; ?>')" type="button" class="btn btn-block btn-danger"><i class="fas fa-minus-circle"></i> Delete</button>
                                                </td>
                                            </tr>
                                        <?php endfor; ?>
                                    </tbody>
...
<script>
    ...
    const ahrefmasterhibah = document.querySelector('.ahrefmasterhibah');

    limaster.classList.add("menu-open");
    ahrefmaster.classList.add("active");
    ahrefmasterhibah.classList.add("active");
</script>
