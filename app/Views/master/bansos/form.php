                    ...
                    <div class="card">
                        <form method="POST" action="<?= $url ?>">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label>NIK <sup class="text-danger">*) Maksimal 16 Digit</sup></label>
                                        <input type="text" class="form-control" maxlength="16" name="nik" id="nik" oninput="validateNIK(this)" value="<?= $nik ?>" required>
                                    </div>
                                    <div class="form-group col-md-6">
                            ...
                            <div class="card-footer text-right">
                                <a href="<?= base_url('master/bansos') ?>" class="btn btn-secondary">Batal</a>
...
<script>
    ...
    const ahrefusulan = document.querySelector('.ahref-master-bansos');
...
<script>
    $(document).ready(function() {
        ...
        $('form').submit(function(event) {
            ...
            $.ajax({
                url: "<?= site_url('master/cek_nik') ?>", // Ganti dengan URL route untuk pengecekan NIK
                type: 'POST',
                data: { nik: nik, id: id},
                dataType: 'json',
                success: function(response) {
                    if (response.exists) {
                        ...
                        Swal.fire({
                            title: 'Peringatan',
                            text: 'NIK sudah terdaftar. Silakan masukkan NIK yang berbeda.',
                ...
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        title: 'Peringatan',
                        text: 'Gagal memeriksa NIK. Silakan coba lagi.',
    ...
    function validateNIK(input) {
        ...
        input.value = input.value.replace(/\D/g, '').slice(0, 16); // Menghapus non-digit dan membatasi panjang menjadi 16 digit
    }
</script>
