        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= site_url('import-excel-hibah/do') ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                ...
                                <span class="text-success text-sm">Download template import excel <a href="<?= base_url('template/template_import_hibah.xlsx' )?>" class="text-success text-bold"><u>disini</u></a></span>
                            </form>
                        </div>
                        <!-- /.card-body -->
                    </div>
